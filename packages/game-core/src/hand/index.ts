import { Card, HandType, HandResult, Rank, Suit } from '../types';
...
export class HandUtil {
  ...
  static isTripleOne(cards: Card[]): HandResult {
    ...
    let tripleRank: number = 0;
    let singleRank: number = 0;
  ...
  static isStraight(cards: Card[], minLength: number = 5): HandResult {
  ...
  static isStraightPair(cards: Card[], minLength: number = 3): HandResult {
  ...
  static isPlane(cards: Card[], minLength: number = 2): HandResult {
