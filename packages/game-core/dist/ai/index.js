...
export class SimpleAI {
    static makeDouDiZhuMove(game, playerId) {
    ...
    static makeGuanDanMove(game, playerId) {
        const player = game.getPlayer(playerId);
        if (!player) {
            return { action: 'pass' };
        }
    ...
    static makeZhaJinHuaMove(game, playerId) {
        const player = game.getPlayer(playerId);
        if (!player) {
            return { action: 'fold' };
        }
    ...
    static findSmallestValidHand(cards) {
    ...
    static findSmallestTriple(cards) {
        const sortedCards = CardUtil.sortCards(cards, true);
    ...
    static findBeatingHand(cards, lastHand) {
        const sortedCards = CardUtil.sortCards(cards, true);
    ...
    static generateAllPossibleHands(cards) {
        const hands = [];
